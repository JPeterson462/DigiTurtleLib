...
public enum FontAwesome {
	...
	public static final String NAME = "FontAwesome";
	
	public final String text;
	
	FontAwesome(int unicode) {
		text = getUnicodeCharacter(unicode);
	}

	private static String getUnicodeCharacter(int unicode) {
